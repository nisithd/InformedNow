...
export default function Home() {
  const [currentView, setCurrentView] = useState('landing'); // 'landing', 'preferences', 'main'
  ...
  // Main News Feed View (placeholder for now)
  if (currentView === 'main') {
    return (
        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Welcome to InformedNow!
            </h2>
            <p className="text-gray-600 mb-6">
              Your personalized news feed based on your interests:
            </p>
            {userPreferences && userPreferences.categories && (
